    ...
    <div class="flex justify-between px-4 mx-auto max-w-screen-xl ">
        <article class="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue">
            ...
            <section class="not-format">
                ...
                <div class="flex justify-end mb-10 gap-3">
                    ...
                    <form method="POST" action="{{ route('articles.destroy', $article->id) }}"
                        ...
                        <input type="submit" value="Delete Post" class="cursor-pointer"/>
                    </form>
                </div>
            </section>
            ...
            <section>
                ...
                <article class="p-6 mb-6 text-base bg-white border-t border-gray-200 $articles = Article::with('user')->get();">
                    <footer class="flex justify-between items-center mb-2">
                        <div class="flex items-center">
                            <p class="inline-flex items-center mr-3 font-semibold text-sm text-gray-900"><img
                                    class="mr-2 w-6 h-6 rounded-full"
